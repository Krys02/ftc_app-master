...
public class CheckmateColorFilter extends GenericCVColorFilter {
    // Color presets
     ...
     */
    public CheckmateColorFilter(ColorPreset filterColor){
     ...
     */
    public CheckmateColorFilter(ColorPreset filterColor, double filterThreshold){
