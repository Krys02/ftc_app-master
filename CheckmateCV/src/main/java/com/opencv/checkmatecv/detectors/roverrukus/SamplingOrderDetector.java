...
import com.opencv.checkmatecv.filters.GenericCVColorFilter;
import com.opencv.checkmatecv.filters.HSVRangeFilter;
import com.opencv.checkmatecv.scoring.MaxAreaScorer;
import com.opencv.checkmatecv.scoring.PerfectAreaScorer;
import com.opencv.checkmatecv.scoring.RatioScorer;
...
/**
 * Created by Maxwell on 9/10/2018.
 *
 * Basic sampling order detector - maybe needs tuning
 */

public class SamplingOrderDetector extends OpenCVDetector {
    ...
    public OpenCV.AreaScoringMethod areaScoringMethod = OpenCV.AreaScoringMethod.MAX_AREA;
    ...
    public GenericCVColorFilter yellowFilter = new CheckmateColorFilter(CheckmateColorFilter.ColorPreset.YELLOW,100);
    public GenericCVColorFilter whiteFilter  = new HSVRangeFilter(new Scalar(0,0,200), new Scalar(50,40,255));
    ...
    public void useDefaults() {
        if(areaScoringMethod == OpenCV.AreaScoringMethod.MAX_AREA){
            addScorer(maxAreaScorer);
        }

        if (areaScoringMethod == OpenCV.AreaScoringMethod.PERFECT_AREA){
