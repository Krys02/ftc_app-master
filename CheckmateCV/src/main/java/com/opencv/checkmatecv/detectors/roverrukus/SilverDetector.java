...
public class SilverDetector extends OpenCVDetector {
    ...
    public OpenCV.AreaScoringMethod areaScoringMethod = OpenCV.AreaScoringMethod.MAX_AREA; // Setting to decide to use MaxAreaScorer or PerfectAreaScorer
