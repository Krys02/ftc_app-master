...
public class GenericDetector extends OpenCVDetector {
    ...
    public GenericCVColorFilter colorFilter       = new CheckmateColorFilter(CheckmateColorFilter.ColorPreset.RED); //Default Yellow filter
