...
public class GoldDetector extends OpenCVDetector {
    ...
    public GenericCVColorFilter yellowFilter      = new CheckmateColorFilter(CheckmateColorFilter.ColorPreset.YELLOW); //Default Yellow filter
